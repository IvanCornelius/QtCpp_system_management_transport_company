/***********************************************************************************************************
**                                                                                                        **
** QCustomPlot, простой в использовании современный виджет для построения графиков для Qt                 **
** Авторское право (C) 2011-2015 Эмануэль Эйхаммер                                                        **
**                                                                                                        **
...
**                                                                                                        **
************************************************************************************************************
** Автор: Эмануэль Эйхаммер                                                                               **
** Веб-сайт/Контакты: http://www.qcustomplot.com/                                                         **
** Дата: 25.04.15                                                                                         **
** Версия: 1.3.1                                                                                          **
** Использована для практической работы №7, студента группы А591, Кузнецова Ивана                         **
*************************************************************************************************************/
